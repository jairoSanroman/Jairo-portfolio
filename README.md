...
Si deseas explorar el código o ejecutar el proyecto en tu máquina:

1. **Clonar el repositorio**:
   ```bash
   git clone https://github.com/jairoSanroman/Jairo-portfolio.git
   cd Jairo-portfolio
   ```
...
Estoy abierto a nuevas oportunidades y colaboraciones. ¡Hablemos!

- **LinkedIn**: [jairo-sanromán-497746279](https://linkedin.com/in/jairo-sanromán-497746279/)
- **Email**: jaironmandvd@gmail.com
- **Ubicación**: Vigo, España 🇪🇸

---

Desarrollado con ❤️ por **Jairo Sanromán** usando Next.js y mucha cafeína.
