...
const experiences = [
  {
    ...
    description: "Trabajo en el mantenimiento de instalaciones bajo altos estándares de higiene y seguridad. Coordinación con equipos multidisciplinares en entornos de gran escala.",
    type: "Laboral",
    imageId: "exp-iss"
  },
  {
    ...
    description: "Soporte técnico y mantenimiento de aplicaciones. Resolución de incidencias en código y colaboración activa con el equipo de desarrollo senior.",
    type: "IT",
  ...
  },
  {
    ...
    period: "2023",
    description: "Desarrollo de módulos funcionales y gestión de bases de datos relacionales. Aplicación de metodologías ágiles en el flujo de trabajo diario.",
    type: "IT",
    imageId: "exp-id3"
  },
  {
    ...
    period: "2021",
    description: "Trabajo en cadena de montaje automotriz bajo estrictos estándares de calidad internacional. Disciplina y eficiencia en procesos industriales críticos.",
    type: "Laboral",
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col items-center mb-20 text-center">
          ...
          <p className="text-muted-foreground max-w-2xl text-lg">
            Trayectoria que combina formación técnica especializada con experiencia en entornos de alta exigencia industrial.
          </p>
        </div>
        ...
        <div className="grid gap-8">
          {experiences.map((exp, index) => {
            ...
            return (
              <div 
                key={index} 
                className="grid md:grid-cols-12 gap-8 bg-card/40 border border-white/5 p-4 md:p-6 rounded-[2rem] hover:bg-card/60 hover:border-primary/20 transition-all duration-500 group shadow-xl backdrop-blur-sm overflow-hidden"
              >
                {/* Columna Izquierda: Imagen (40%) */}
                <div className="md:col-span-5 relative h-64 md:h-auto min-h-[250px] rounded-3xl overflow-hidden bg-muted/20">
                  <Image 
