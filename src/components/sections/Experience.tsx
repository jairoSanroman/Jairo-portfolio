      ...
      <div className="max-w-5xl mx-auto">
        <div className="flex flex-col items-center mb-20 text-center">
          ...
          <p className="text-muted-foreground max-w-2xl">
            Mi trayectoria combina formación técnica especializada con experiencia en entornos industriales de alta exigencia.
          </p>
        </div>
        ...
        <div className="space-y-12">
          {experiences.map((exp, index) => {
            ...
            return (
              <div 
                key={index} 
                className="grid md:grid-cols-5 gap-8 bg-card border border-border p-6 rounded-3xl hover:border-primary/30 transition-all duration-300 group shadow-sm"
              >
                {/* Columna Izquierda: Imagen */}
                <div className="md:col-span-2 relative h-48 md:h-full min-h-[160px] rounded-2xl overflow-hidden bg-muted">
                  <Image 
